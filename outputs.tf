output "keypair_name" {
  ...
  description = "OpenStack keypair name used by KYPO proxy-jump and Kuberentes cluster instances"
}

output "private_key" {
  value       = tls_private_key.admin.private_key_pem
  description = "SSH private key for accessing KYPO proxy-jump and Kuberentes cluster instances"
}

output "network_id" {
  value       = openstack_networking_network_v2.network.id
  description = "Id of OpenStack internal network used by KYPO proxy-jump and Kuberentes cluster instances"
}
